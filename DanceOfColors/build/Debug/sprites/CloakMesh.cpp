...
static sf::Color innerColor(float /*t*/, float v) {
    uint8_t r = static_cast<uint8_t>(70 - 25 * v);
    uint8_t g = static_cast<uint8_t>(4);
    uint8_t b = static_cast<uint8_t>(4);
    return {r, g, b, 255};
}

CloakMesh::CloakMesh() : m_colorFn(outerColor) {}
